...
math.graph = (function(){
	...
	+'</style>'
	    ...
	    +'<div class="math-admin math-graph-admin math-graph-save-btn">'
	    +'<svg class="math-box-icon">'
	    +'<use xlink:href="#math-save-icon"></use>'
	    +'</svg>'
	    +'</div>'
	    +'<div class="math-admin math-graph-admin math-graph-force-btn">'
	    +'<svg class="math-box-icon">'
	    +'<use xlink:href="#math-force-icon"></use>'
	    +'</svg>'
	    +'</div>'
	    +'<div class="math-admin math-graph-admin math-graph-drag-btn">'
	    +'<svg class="math-box-icon">'

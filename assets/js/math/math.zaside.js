...
math.aside = (function () {
  ...
  configMap = {
    main_html: String()
      ...
      +'<li><a href="https://cheredeprince.net">Accueil</a></li>'
      +'<li><a href="/"  class="active">Math</a></li>'
      +'<li><a href="https://cheredeprince.net/services/">Services</a></li>'
      +'<li><a href="https://cheredeprince.net/blog">Blog</a></li>'
      +'</ul>'
      +'</nav>'
      +'</div>'
      +'</header>'
      ...
      +'<a href="/session/new" class="btn info">Se connecter</a><br/><br/>'
